 ...
 */
final class Version20240628040805 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE commande (id INT AUTO_INCREMENT NOT NULL, ref VARCHAR(10) NOT NULL, filing_date DATE NOT NULL, return_date DATE NOT NULL, payment_date DATE NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4');
        ...
        $this->addSql('CREATE TABLE item (id INT AUTO_INCREMENT NOT NULL, detail_item LONGTEXT DEFAULT NULL, price DOUBLE PRECISION NOT NULL, quantity SMALLINT NOT NULL, article_id INT NOT NULL, service_id INT NOT NULL, user_id INT NOT NULL, commande_id INT NOT NULL, item_status_id INT NOT NULL, INDEX IDX_1F1B251E7294869C (article_id), INDEX IDX_1F1B251EED5CA9E6 (service_id), INDEX IDX_1F1B251EA76ED395 (user_id), INDEX IDX_1F1B251E82EA2E54 (commande_id), INDEX IDX_1F1B251E672D164D (item_status_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4');
